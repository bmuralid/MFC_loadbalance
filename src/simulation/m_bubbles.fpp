...
contains
    ...
    subroutine s_initialize_bubbles_module
        ...
        @:ALLOCATE(bub_adv_src(-buff_size_lb(1) +0:m + buff_size_lb(2), &
            -buff_size_lb(3) + 0:n + buff_size_lb(4), &
            -buff_size_lb(5) + 0:p + buff_size_lb(6)))
        @:ALLOCATE(bub_r_src(-buff_size_lb(1) + 0:m + buff_size_lb(2), &
            -buff_size_lb(3) + 0:n + buff_size_lb(4), &
            -buff_size_lb(5) + 0:p + buff_size_lb(6), 1:nb))
        @:ALLOCATE(bub_v_src(-buff_size_lb(1) + 0:m + buff_size_lb(2), &
            -buff_size_lb(3) + 0:n + buff_size_lb(4), &
            -buff_size_lb(5) + 0:p + buff_size_lb(6), 1:nb))
        @:ALLOCATE(bub_p_src(-buff_size_lb(1) + 0:m + buff_size_lb(2), &
            -buff_size_lb(3) + 0:n + buff_size_lb(4), &
            -buff_size_lb(5) + 0:p + buff_size_lb(6), 1:nb))
        @:ALLOCATE(bub_m_src(-buff_size_lb(1) + 0:m + buff_size_lb(2), &
            -buff_size_lb(3) + 0:n + buff_size_lb(4), &
            -buff_size_lb(5) + 0:p + buff_size_lb(6), 1:nb))
